...
Contributed as a web developer for developing a web application for a tourism company at _Dubai, UAE_. Used **ASP.NET MVC with C#** as backend technology. This web application consisted of a _Fronted along with an Admin-panel_.

_Note: This website is down, roundabout for the past 2 years, that's why didn't include the link._
